...
<div>
  ...
  <p>
    ...
    and
    <code>height</code>
    of a data graphic will respond reactively to (1) changes to the parent
    container size (if the width and height are not explicitly set) and (2)
    changes to the actual width and height props.
  </p>
