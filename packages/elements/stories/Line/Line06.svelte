...
<input style="position: absolute; left:0; top:0" type="range" bind:value={w} min="75" max="900" />
<input style="position: absolute; left:0; top:40px" type="range" bind:value={h} min="75" max="900" />
